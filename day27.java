...
Edge Cases:
If start and end are the same and there are no edges, the path length is 0.
If there is no connection between start and end, return -1.
If the graph is fully connected, ensure the shortest path is calculated correctly.
*/
